...
static PyObject *
_cffi_f_zmq_sleep(PyObject *self, PyObject *arg0)
{
  int x0;
...
static PyObject *
_cffi_f_zmq_stopwatch_start(PyObject *self, PyObject *noarg)
{
  void * result;

  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = zmq_stopwatch_start(); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
static PyObject *
_cffi_f_zmq_stopwatch_stop(PyObject *self, PyObject *arg0)
{
  void * x0;
  Py_ssize_t datasize;
...
static int _cffi_const_ZMQ_IDENTITY_FD(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_IDENTITY_FD);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_IDENTITY_FD", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_IMMEDIATE(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_IDENTITY_FD(lib);
}
...
static PyMethodDef _cffi_methods[] = {
  ...
  {"zmq_sleep", _cffi_f_zmq_sleep, METH_O, NULL},
  {"zmq_socket", _cffi_f_zmq_socket, METH_VARARGS, NULL},
  {"zmq_socket_monitor", _cffi_f_zmq_socket_monitor, METH_VARARGS, NULL},
  {"zmq_stopwatch_start", _cffi_f_zmq_stopwatch_start, METH_NOARGS, NULL},
  {"zmq_stopwatch_stop", _cffi_f_zmq_stopwatch_stop, METH_O, NULL},
